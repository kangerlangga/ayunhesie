...
<!-- jQuery Sparkline -->
<script src="{{  url('') }}/assets2/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>
...
<!-- Atlantis JS -->
<script src="{{  url('') }}/assets2/js/atlantis.min.js"></script>

<!-- Atlantis DEMO methods, don't include it in your project! -->
{{-- <script src="{{  url('') }}/assets2/js/setting-demo.js"></script>
<script src="{{  url('') }}/assets2/js/demo.js"></script> --}}
<script>
    Circles.create({
        id:'circles-1',
        radius:45,
