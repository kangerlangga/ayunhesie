...
<body>
    ...
    <div class="row">
        ...
        <form method="POST" action="{{ route('login.verifikasi') }}" enctype="multipart/form-data">
            ...
            <button class="btn btn-block btn-info rounded-pill mt-3 pt-2 pb-2 fw-bold" style="font-size: medium;"><b>LOGIN</b></button>
...
<script src="{{  url('') }}/assets1/js/main2.js"></script>
